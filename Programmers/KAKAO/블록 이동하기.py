# 회전
## 가로로 놓인 상태에서 아래로 회전하는 경우, 아래에는 벽이 없어야 한다.
## 가로로 놓인 상태에서 위쪽으로 회전하는 경우, 위에는 벽이 없어야 한다.
## 세로로 놓인 상태에서 오른쪽으로 회전하는 경우, 오른쪽에는 벽이 없어야 한다.
## 세로로 놓인 상태에서 왼쪽으로 회전하는 경우, 왼쪽에는 벽이 없어야 한다.
## 초기에 주어진 맵을 변형하여 외곽에 벽을 둘 수 있다.
